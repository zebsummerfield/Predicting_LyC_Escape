"""
This code plots two 2D histograms side by side to see how accurate the symbolic regression predictions are, 
one for the test data and one for the train data.
"""
...
# plots a 2d histogram of test X against test Y (predicted vs actual),
...
# then plots the median of test X against the median of test Y for each bin (predicted vs actual)
...
# plots a 2d histogram of train X against train Y (predicted vs actual),
# where the number of galaxies in a bin dictates it's colour
...
# then plots the median of train X against the median of train Y for each bin (predicted vs actual)
